CREATE DATABASE IF NOT EXISTS IF NOT EXISTS petlife CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE petlife;
...
CREATE TABLE pet (
    ...
    FOREIGN KEY (fk_usuario_id) REFERENCES usuario(id) ON DELETE CASCADE ON DELETE CASCADE
);
